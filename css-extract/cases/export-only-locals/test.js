...
var _3 = "foo__style__cClass";`);
  expect(mainContent).toContain(`console.log({ aClass: _style_css__rspack_import_0.aClass, bClass: _style_css__rspack_import_0.bClass, cClass: _style_css__rspack_import_0.cClass })`);
};
